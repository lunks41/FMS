...
namespace FMS.Data
{
    ...
    {
        #region Sale
        Task<IEnumerable<SaleHd>> GetAllSale(string? Fillter);
        ...
        #region Expense
        Task<IEnumerable<OwnerExpenseHd>> GetAllExpense(string? Fillter);
        ...
        #region Income
        Task<IEnumerable<IncomeHd>> GetAllIncome(string? Fillter);
